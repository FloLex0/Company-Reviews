<?php 
 include 'components/connect.php';
   ...
   $select_posts = $conn->prepare("SELECT * FROM posts WHERE title LIKE '%$name%' or cui LIKE '%$name%'");
...
<div class="box" id="showdata">
   ...
   <h3 class="title"><?= $fetch_post['cui']; ?></h3>
...
<?php
   ...
   echo '<p class="empty">Nu exista rezultate</p>';
}
?>