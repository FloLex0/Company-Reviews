...
<section class="view-post">
   ...
   <div class="heading"><h1>Company details</h1> <a href="all_posts.php" class="inline-option-btn" style="margin-top: 0;">all posts</a></div>
   ...
   <div class="row">
      <div class="col">
         ...
         <br></br>
         <h5 class="title-second"><?= $fetch_post['cui']; ?></h5>
        
         <h5 class="title-second"><?= $fetch_post['adresa']; ?></h5>
