...
if(isset($_POST['submit'])){
   ...
   if($verify_email->rowCount() > 0){
      ...
      if($c_pass == 1){
         $insert_user = $conn->prepare("INSERT INTO `posts`(id, title, image, cui, email, password) VALUES(?,?,?,?,?,?)");
         $insert_user->execute([$id, $name, $rename, $vatnumber, $email, $pass]);
...
<section class="account-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p class="placeholder">company name <span>*</span></p>
      <input type="text" name="name" required maxlength="50" placeholder="enter your name" class="box">
      <p class="placeholder">your email <span>*</span></p>
      <input type="email" name="email" required maxlength="50" placeholder="enter your email" class="box">
      <p class="placeholder">your vat number <span>*</span></p>
      <input id="namn" pattern="[a-zA-Z]{2}\d{8}" type="text"  name="vatnumber" required minlength="6" maxlength="50" placeholder="EX:RO12345678" class="box">
